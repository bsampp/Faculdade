...
int ataque_jogador(string tabuleiroRival[][Tamanho], string tabuleiroRivalVisto[][Tamanho], int *contador, int *errosJogador,int i)
{
    SetConsoleOutputCP(CP_UTF8);
    int c, ln;
    char l;
...
int ataque_maquina(string tabuleiro[][Tamanho], int *errosMaquina, int i)
{
    bool repetir(true);
    int c, ln;
    char l;
...
int ataque_maquina_dificil(string tabuleiro[][Tamanho], int *errosMaquina, int i)
{
    bool repetir(true);
    int c, ln;
    char l;
...
float porcent(int *acertosJ, int *errosJ, int *tiros, int i)
{
...
void preencheDados(usuario dados, int i)
{
...
int main()
{
    ...
    while (Continuar == 'S')
    {
        preencheDados(info[max_jogadores], i);
        ...
        do
        {
            ...
            acertosJogadorContador[i] += ataque_jogador(tabuleiroRival, tabuleiroRivalVisto, tirosContador, errosJogadorContador, i);
            if ((info->dificuldade == 'N') || (info->dificuldade == 'n'))
            {
                acertosMaquinaContador[i] += ataque_maquina(tabuleiro, errosMaquinaContador, i);
            }
            else if ((info->dificuldade == 'D') || (info->dificuldade == 'd'))
            {
                acertosMaquinaContador[i] += ataque_maquina_dificil(tabuleiro, errosMaquinaContador, i);
            }
            system("cls");
            exibir_tabuleiro_jogador(tabuleiro);
        ...
        if ((acertosJogadorContador[i] == pontosNecessarios) || (acertosJogadorContador[i] > acertosMaquinaContador[i]))
        {
            ...
            cout << fixed << setprecision(2) << "Porcentagem de acertos: " << porcent(acertosJogadorContador, errosJogadorContador, tirosContador, i) << "%" << endl;
